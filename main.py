...
model.add(layers.GRU(16, input_shape=(None, 1)))
model.add(layers.Dense(1))

model.compile(optimizer='rmsprop', loss='mse')
history = model.fit(train_data, train_res, epochs=70, validation_data=(val_data, val_res), batch_size=45)
